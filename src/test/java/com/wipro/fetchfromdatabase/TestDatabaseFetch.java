package com.wipro.fetchfromdatabase;
...
import com.wipro.testng_ListnerTestcase;
...
public class TestDatabaseFetch {
	...
	private static final org.apache.logging.log4j.Logger log = LoggerHelper.getLogger(TestNG_ListnerTestcase.class);
	@Test
	...
	// fetch the db url , password and username of the my sql db 
		...
		while (rs.next()) {
			String usrname = rs.getString("title");
			String paswd = rs.getString("genre");
